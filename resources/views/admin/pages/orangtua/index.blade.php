            ...
            <table class="min-w-full divide-y divide-gray-200" id="table-ortu">
                <thead class="bg-gray-800 text-white text-center">
                    <tr>
                        ...
                        <th class="px-3 py-3 border-[0.5px] border-gray-100 text-xs font-medium uppercase tracking-wider">Nama Orang Tua</th>
                        ...
                        <th class="px-3 py-3 border-[0.5px] border-gray-100 text-xs font-medium uppercase tracking-wider">Kontak</th>
                        <th class="px-3 py-3 border-[0.5px] border-gray-100 text-xs font-medium uppercase tracking-wider">Alamat</th>
                        <th class="px-3 py-3 border-[0.5px] border-gray-100 text-xs font-medium uppercase tracking-wider">Action</th>
                    </tr>
                </thead>
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-3 py-3 border-[0.5px] border-gray-100 whitespace-nowrap">{{ $ortu->nama_ortu }}</td>
                        <td class="px-3 py-3 border-[0.5px] border-gray-100 whitespace-nowrap text-center">{{ $ortu->jenis_kelamin }}</td>
                        <td class="px-3 py-3 border-[0.5px] border-gray-100 whitespace-nowrap">{{ $ortu->siswa->namasiswa ?? '-' }}</td>
                        <td class="px-3 py-3 border-[0.5px] border-gray-100 whitespace-nowrap">{{ $ortu->kontak }}</td>
                        <td class="px-3 py-3 border-[0.5px] border-gray-100 whitespace-nowrap">{{ $ortu->alamat }}</td>
